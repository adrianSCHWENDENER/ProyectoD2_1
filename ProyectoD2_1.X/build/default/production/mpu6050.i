...
float MPU6050_Read_Ax(void)
{
    return (float)(((int)(MPU6050_Read(0x3B) << 8 | MPU6050_Read(0x3C)))/(float)16384);
}

float MPU6050_Read_Ay(void)
{
    return (float)(((int)(MPU6050_Read(0x3D) << 8 | MPU6050_Read(0x3E)))/(float)16384);
}

float MPU6050_Read_Az(void)
{
    return (float)(((int)(MPU6050_Read(0x3F) << 8 | MPU6050_Read(0x40)))/(float)16384);
}

float MPU6050_Read_Gx(void)
{
    return (float)(((int)(MPU6050_Read(0x43) << 8 | MPU6050_Read(0x44)))/(float)131);
}

float MPU6050_Read_Gy(void)
{
    return (float)(((int)(MPU6050_Read(0x45) << 8 | MPU6050_Read(0x46)))/(float)131);
}

float MPU6050_Read_Gz(void)
{
    return (float)(((int)(MPU6050_Read(0x47) << 8 | MPU6050_Read(0x48)))/(float)131);;
}

float MPU6050_Read_Temperature(void)
{
    return (float)(((int)(MPU6050_Read(0x41) << 8 | MPU6050_Read(0x42)))/(float)340+(float)36.53);
}
